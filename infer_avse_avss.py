...
def main(args):
    ...
    #5. infer #note:This is only for the inference ; the calculation of evaluation metrics will be improved later.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="AVSS/AVSE Model Testing")
